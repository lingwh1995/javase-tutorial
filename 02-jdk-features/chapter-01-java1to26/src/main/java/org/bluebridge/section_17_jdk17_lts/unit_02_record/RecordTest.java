package org.bluebridge.section_17_jdk17_lts.unit_02_record;
...
public class RecordTest {
    ...
    public void testRecordCreateAndToString() {
        // ===== 旧版实现方式(JDK 16 之前): 传统 POJO 需要手写类 + 构造器 + 访问器 + toString 等 =====
        // public class Person {
        ...
        //     // 还需手写 equals()/hashCode()/toString()
        // }
        // ===== 新版实现方式(JDK 16 起): record 一行声明, 编译器自动生成 =====
