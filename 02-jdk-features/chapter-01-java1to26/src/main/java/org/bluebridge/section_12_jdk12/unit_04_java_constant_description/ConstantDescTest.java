package org.bluebridge.section_12_jdk12.unit_04_java_constant_description;
...
/**
 * JDK 12 java.lang.constant.ConstantDesc API（JEP 334，STANDARD 正式特性）
 *
 ...
 *
 * 注意：该 API 在 JDK 12 中为 STANDARD 正式特性（JEP 334），无需启用预览选项。
 *
 * 演化历程: ConstantDesc API JDK 12（JEP 334, STANDARD 正式特性）至今仍在使用
 *
 * @author lingwh
...
public class ConstantDescTest {
    ...
    public void testClassDescBasic() {
        ...
        // 使用 of 方法创建数组类描述符
        ClassDesc intArrayDesc = ClassDesc.of("int").arrayType();
    ...
    public void testDirectMethodHandleDesc() {
        ...
        DirectMethodHandleDesc parseIntDesc = MethodHandleDesc.ofMethod(
