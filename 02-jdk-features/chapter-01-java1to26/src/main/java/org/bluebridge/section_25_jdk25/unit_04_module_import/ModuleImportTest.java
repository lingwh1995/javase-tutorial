package org.bluebridge.section_25_jdk25.unit_04_module_import;

import org.junit.Test;

/**
 * JDK 25 模块导入声明测试(STANDARD 正式特性)
 *
 * 模块导入声明(Module Import Declarations, JEP 511) 是 JDK 25 的
 * STANDARD 正式特性, 无需 --enable-preview。
 *
 ...
 *   - JDK 24: JEP 486 第二次预览
 *   - JDK 25: JEP 511 转正为正式特性
 *   - JDK 26: 保持正式特性
 *
 * @author lingwh
...
public class ModuleImportTest {
    ...
    // JDK 25 STANDARD 正式特性，无需 --enable-preview
    // 实际使用时取消注释以下行:
    // import module java.base;

    /**
     * 测试模块导入声明的基本概念(STANDARD)
     * JDK 25 STANDARD 正式特性，无需 --enable-preview
     * 模块导入声明使用 import module 关键字
     */
    @Test
    public void testModuleImportConcept_Standard() {
        // JDK 25 STANDARD 正式特性，无需 --enable-preview
    ...
    /**
     * 测试模块导入实际使用场景(STANDARD)
     * JDK 25 STANDARD 正式特性，无需 --enable-preview
     * 演示使用模块导入后可以简化代码
     */
    @Test
    public void testModuleImportUsage_Standard() {
        // JDK 25 STANDARD 正式特性，无需 --enable-preview
    ...
    /**
     * 测试模块导入与普通导入的对比(STANDARD)
     * JDK 25 STANDARD 正式特性，无需 --enable-preview
     * 模块导入的优势在于减少 import 语句数量
     */
    @Test
    public void testModuleImportCompare_Standard() {
        // JDK 25 STANDARD 正式特性，无需 --enable-preview
        ...
        System.out.println("1. 模块导入是 JDK 25 正式特性, 无需 --enable-preview");
    ...
    /**
     * 测试模块导入对不同模块的支持(STANDARD)
     * JDK 25 STANDARD 正式特性，无需 --enable-preview
     * 除了 java.base 外, 还可以导入其他模块
     */
    @Test
    public void testModuleImportOtherModules_Standard() {
        // JDK 25 STANDARD 正式特性，无需 --enable-preview
