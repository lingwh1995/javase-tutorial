package org.bluebridge.section_23_jdk23.unit_02_markdown_doc;

import org.junit.Test;

/**
 * JDK 23 Markdown 文档注释测试（PREVIEW 预览特性）
 *
...
public class MarkdownDocCommentTest {
    ...
    // 但是 javac --enable-preview --release 23 可以正常编译

    /// 测试 Markdown 文档注释格式(PREVIEW)
    ///
    ...
    @Test
    public void testMarkdownDocComment_Preview() {
        // JDK 23 PREVIEW 特性，需要 --enable-preview
    ...
    /// 测试 Markdown 文档注释中的各种格式(PREVIEW)
    ///
    /// ## 标题级别演示
    ///
    /// ### 三级标题
    ...
    /// JDK 23 PREVIEW 特性，需要 --enable-preview
    @Test
    public void testMarkdownFormatting_Preview() {
        // JDK 23 PREVIEW 特性，需要 --enable-preview
