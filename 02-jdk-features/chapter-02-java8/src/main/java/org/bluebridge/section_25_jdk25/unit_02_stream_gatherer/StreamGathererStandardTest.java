package org.bluebridge.section_25_jdk25.unit_02_stream_gatherer;
...
public class StreamGathererStandardTest {
    ...
    public void testWindowFixed() {
        ...
        // 当流元素数量正好是窗口大小的整数倍
        List<Integer> exact = Stream.of(1, 2, 3, 4, 5, 6)
                .gather(Gatherers.windowFixed(3))
                .toList();
        ...
        // 单个元素分组
        List<Integer> single = Stream.of(1)
    ...
    public void testFold() {
        ...
        var result = numbers.stream()
                .gather(Gatherers.fold(() -> new java.util.ArrayList<List<Integer>>() {{
                            add(new java.util.ArrayList<>()); // 奇数
                            add(new java.util.ArrayList<>()); // 偶数
                        }},
                        (acc, element) -> {
                            if (element % 2 == 0) {
