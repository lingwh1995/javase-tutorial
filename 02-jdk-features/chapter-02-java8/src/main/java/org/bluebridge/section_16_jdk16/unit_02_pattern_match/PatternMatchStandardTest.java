...
/**
 * JDK 16 instanceof 模式匹配测试(STANDARD 正式特性)
 *
 * instanceof 模式匹配(JEP 394) 在 JDK 16 中转正为 STANDARD 正式特性, 不再需要 --enable-preview 参数。
 ...
 */
public class PatternMatchStandardTest {
