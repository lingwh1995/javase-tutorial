package org.bluebridge.structure.adapter.adapter_e.controller;
...
import org.bluebridge.structure.adapter.adapter_e.service.XxjlAdapterService;
import org.bluebridge.structure.adapter.adapter_e.service.XxjlSerivice;

/**
 * 需求：保存信息交流的同时，发送邮件并且短信提醒
 *
 * @author lingwh
 * @date 2026/7/22 08:23
 */
