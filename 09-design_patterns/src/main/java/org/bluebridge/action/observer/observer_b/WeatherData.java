package org.bluebridge.action.observer.observer_b;

/**
 * 气象数据
 *
 * 1. 包含了最新的天气信息
 * 2. 包含了 ConcreteConditions
 * 3. 如果数据有更新，就调用 concreteConditions.update() 完成最新信息推送
 *
 * @author lingwh
...
public class WeatherData {
    ...
    public void setData(String temperature, String pressure, String humidity) {
        ...
        // 将最新的信息推送给接入方：ConcreteConditions，即调用接入方的 update()
        dataChange();
    }
