package org.bluebridge.reflect.section_06_reflect_demo.unit_02_my_junit;
...
public class MyJunitTest {
    ...
    public static void main(String[] args) throws ClassNotFoundException, InvocationTargetException, IllegalAccessException, InstantiationException {
        // 1. 获取测试类的Class文件
        Class clazz = Class.forName("org.bluebridge.reflect.section_06_reflect_demo.unit_02_my_junit.MyJunit");
