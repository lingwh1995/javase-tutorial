...
public class CollectionInitTest {
    ...
    private static final List<Integer> UNMODIFIABLE_LIST_WITH_NULL_JAVA8 = Collections
            .unmodifiableList(Arrays.asList(1, null, 3));
    ...
    private static final Map<String, Integer> UNMODIFIABLE_LARGE_MAP_JAVA9 = Map.ofEntries(Map.entry("a", 1),
            Map.entry("b", 2), Map.entry("c", 3));

    // 使用 Collections.unmodifiableList() 初始化不可变集合 ⭐⭐⭐⭐⭐
    private static final List<Integer> UNMODIFIABLE_LIST_WITH_NULL_JAVA9 = Collections
            .unmodifiableList(new ArrayList<>(List.of(1, null, 3)));
