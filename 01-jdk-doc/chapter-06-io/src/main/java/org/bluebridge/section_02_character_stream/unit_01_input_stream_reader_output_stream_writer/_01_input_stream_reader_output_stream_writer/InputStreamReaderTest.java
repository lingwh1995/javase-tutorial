package org.bluebridge.section_02_character_stream.unit_01_input_stream_reader_output_stream_writer._01_input_stream_reader_output_stream_writer;
...
/**
 * 字符输入流（字节流到字符流的桥梁，可以将字节流转换为字符流，可以指定字符编码格式）
 *
 * @author lingwh
