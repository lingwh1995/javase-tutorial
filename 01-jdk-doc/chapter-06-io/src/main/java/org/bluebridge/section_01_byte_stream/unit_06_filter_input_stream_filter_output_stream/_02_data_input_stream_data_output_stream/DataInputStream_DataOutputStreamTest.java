package org.bluebridge.section_01_byte_stream.unit_06_filter_input_stream_filter_output_stream._02_data_input_stream_data_output_stream;
...
/**
 * DataInputStream 数据输入流允许应用程序以机器无关的方式从底层输入流中读取基本的Java类型
 *
 * @author lingwh
