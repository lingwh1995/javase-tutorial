 ...
 *    - 如果需要解析为有符号数，直接解析即可
 *    - 如果需要解析为无有符号数，使用位运算 & 0xFF 把符号位抹去（& 0xF 操作本质上是只保留低8位，其他位都不要了）
 *    int i = -126;  // 32 位 int 的补码: 1111 1111 1111 1111 1111 1111 1000 0010
 *    
 *    -126 => 原码: 1000 0000 0000 0000 0000 0000 0111 1110
 *    -126 => 反码: 1111 1111 1111 1111 1111 1111 1000 0001
 *    -126 => 补码: 1111 1111 1111 1111 1111 1111 1000 0010
 * 
 *    int result = i & 0xFF
 ...
 *    说明：& 0xFF 只保留低 8 位，将 byte 类型的有符号值映射为 0~255 的无符号 int 值，不涉及反码/原码转换。
 *
 * @author lingwh
